...
void ChessGame::startGame()
{
	...
	view->printAt(19, 1, "Use ([Ctrl +] or [Ctrl Shift =]) and [Ctrl -] to resize console on Linux.");
	view->printAt(20, 1, "Input a command with \"[a-h][1-8] [a-h][1-8]\", more options will be added later.");
